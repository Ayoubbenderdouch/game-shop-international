    ...
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-center">
          <LogIn className="w-12 h-12 mx-auto mb-4 text-neon-purple animate-pulse" />
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <button
            ...
            className="w-full neon-button py-3 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
