...
import { ArrowRight, Gamepad2, CreditCard, Gift, Tv, Zap, Trophy, Star, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-16">
      ...
      >
        ...
        <div className="relative z-10 text-center py-24 px-4">
          ...
          >
            <Link to="/shop" className="neon-button inline-flex items-center space-x-2 group">
              <span>{t('home.hero.cta')}</span>
              <ArrowRight className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link to="/shop?sort=popular" className="px-6 py-3 border-2 border-neon-purple rounded-lg hover:bg-neon-purple/10 transition-all inline-flex items-center space-x-2">
      ...
      >
        {[
          ...
          >
            <h3 className="text-3xl font-bold text-neon-purple mb-2">{stat.number}</h3>
            ...
            >
              <Link to={`/shop?category=${category.slug}`}>
                ...
                >
                  ...
                  <h3 className="font-semibold group-hover:text-neon-purple transition-colors">{category.name}</h3>
                </motion.div>
              </Link>
            </motion.div>
          ))}
      ...
      <section>
        <div className="flex items-center justify-between mb-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Link to="/shop" className="text-neon-purple hover:text-neon-pink transition-colors flex items-center space-x-1 group">
              <span>View All</span>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <Link to="/register" className="neon-button inline-flex items-center space-x-2">
