          ...
          <div className="mb-6">
            <div className="flex items-center">
              ...
              <div className="flex items-center border border-dark-lighter rounded-md">
                ...
                <span className="mx-3 w-8 text-center text-text-light">
                  {quantity}
                </span>
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-text-light focus:outline-none px-3 py-2"
                  disabled={
                    !product.is_infinite && quantity >= product.quantity
                  }
                >
                  <svg
                    className="h-4 w-4"
          ...
          {product.structure === "configurable" ? (
            <div className="mb-6">
              <p className="text-yellow-500 mb-3">
                هذا المنتج يحتوي على عدة خيارات، يرجى اختيار الخيار المناسب
              </p>
      ...
      <div className="mb-12">
        <Card padding="none">
          ...
          <div className="p-6">
            ...
            <p className="text-text-light">
              متوفر {product.quantity} قطعة في المخزن.
            </p>
          </div>
        </Card>
      </div>
                    ...
                    {relatedProduct.sale_price ? (
                      <div className="flex items-center">
                        <span className="text-primary font-semibold">
                          {relatedProduct.sale_price.toFixed(2)} ر.س
                        </span>
