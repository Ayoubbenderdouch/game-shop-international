        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="mb-8">
                    ...
                    <div class="products-grid-amounts-inline">
                        @foreach($amountVariations as $variation)
                        <a href="{{ route('product.show', $variation->slug) }}"
                           class="product-amount-card-inline scroll-animate {{ $variation->id == $product->id ? 'active' : '' }}">
                            <div class="product-amount-body-inline">
                                <div class="amount-badge-inline">
                                    @php
                                        $currency = $variation->currency == 'SAR' ? 'SAR' : ($variation->currency == 'AED' ? 'AED' : '$');
                                ...
                                <div class="product-price-inline">
                                    <span class="amount-price-inline">${{ number_format($variation->selling_price, 2) }}</span>
                                </div>
                            </div>
...
@push('styles')
<style>
/* Amount Selection Grid - Same as amounts page */
.products-grid-amounts-inline {
    display: grid;
...
/* Product Amount Card - Same as amounts page */
.product-amount-card-inline {
...
.amount-badge-inline {
    ...
    background: linear-gradient(135deg, #F4C430, #E5B820);
    color: #2E2370;
    padding: 12px 25px;
    border-radius: 50px;
    font-size: 1.3rem;
