...
<div class="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
    ...
    <section class="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
            @php
                $statistics = [
                    ['number' => number_format($stats['total_customers'] ?? 5000) . '+', 'label' => __('app.home.stats.happy_customers'), 'icon' => 'users', 'color' => 'cyan'],
                    ['number' => number_format($stats['total_products'] ?? 100) . '+', 'label' => __('app.home.stats.digital_products'), 'icon' => 'package', 'color' => 'purple'],
                    ['number' => '24/7', 'label' => __('app.home.stats.instant_delivery_247'), 'icon' => 'clock', 'color' => 'green'],
                    ['number' => ($stats['countries_served'] ?? 30) . '+', 'label' => __('app.home.stats.countries_served'), 'icon' => 'globe', 'color' => 'orange'],
                ];
            @endphp
               ...
               class="group relative">
                ...
                <div class="relative bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-6 text-center hover:border-cyan-500/50 transition-all hover:scale-105">
                    ...
                    <p class="text-slate-400 text-sm">
                        {{ $category->products_count ?? 0 }} {{ __('app.home.products') }}
                    </p>
                </div>
            </a>
            @endforeach
