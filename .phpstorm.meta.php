...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/youcefs/Documents/GitHub/Game-shop/public/storage' => 'string',
            ...
            'mail.mailers.brevo.host' => 'string',
            'mail.mailers.brevo.port' => 'string',
            'mail.mailers.brevo.encryption' => 'string',
            'mail.mailers.brevo.username' => 'string',
            'mail.mailers.brevo.password' => 'string',
            'mail.mailers.brevo.timeout' => 'NULL',
            'mail.mailers.brevo.local_domain' => 'string',
            ...
            'services.brevo.api_key' => 'string',
            'services.brevo.smtp_username' => 'string',
            'services.brevo.smtp_password' => 'string',
            'services.brevo.smtp_host' => 'string',
            'services.brevo.smtp_port' => 'string',
            'services.brevo.sms_sender' => 'string',
            'services.brevo.list_id' => 'string',
            'services.stripe.key' => 'string',
            'services.stripe.secret' => 'string',
            'services.stripe.webhook_secret' => 'string',
            'services.likecard.api_url' => 'string',
            'services.likecard.device_id' => 'string',
            'services.likecard.email' => 'string',
            'services.likecard.security_code' => 'string',
            'services.likecard.phone' => 'string',
            'services.likecard.key' => 'string',
            'services.likecard.secret_key' => 'string',
            'services.likecard.secret_iv' => 'string',
            'services.likecard.default_lang_id' => 'integer',
            'services.likecard.cache_categories' => 'integer',
            'services.likecard.cache_products' => 'integer',
            'services.likecard.sync_batch_size' => 'integer',
            'services.likecard.sync_delay_ms' => 'integer',
            'services.likecard.max_retries' => 'integer',
            'services.likecard.retry_delay' => 'integer',
            'services.likecard.default_margin' => 'integer',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/youcefs/Documents/GitHub/Game-shop/public/storage','logging.default','logging.deprecations.channel',
...
'mail.mailers.failover.transport','mail.mailers.failover.mailers','mail.mailers.roundrobin.transport','mail.mailers.roundrobin.mailers','mail.mailers.brevo.transport',
'mail.mailers.brevo.host','mail.mailers.brevo.port','mail.mailers.brevo.encryption','mail.mailers.brevo.username','mail.mailers.brevo.password',
'mail.mailers.brevo.timeout','mail.mailers.brevo.local_domain','mail.from.address','mail.from.name','mail.markdown.theme',
...
'services.slack.notifications.channel','services.brevo.api_key','services.brevo.smtp_username','services.brevo.smtp_password','services.brevo.smtp_host',
'services.brevo.smtp_port','services.brevo.sms_sender','services.brevo.list_id','services.stripe.key','services.stripe.secret',
'services.stripe.webhook_secret','services.likecard.api_url','services.likecard.device_id','services.likecard.email','services.likecard.security_code',
'services.likecard.phone','services.likecard.key','services.likecard.secret_key','services.likecard.secret_iv','services.likecard.default_lang_id',
'services.likecard.cache_categories','services.likecard.cache_products','services.likecard.sync_batch_size','services.likecard.sync_delay_ms','services.likecard.max_retries',
'services.likecard.retry_delay','services.likecard.default_margin','session.driver','session.lifetime','session.expire_on_close',
...
'dompdf.options.enable_remote','dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','sanctum.stateful',
...
'sanctum.middleware.validate_csrf_token','excel.exports.chunk_size','excel.exports.pre_calculate_formulas','excel.exports.strict_null_comparison','excel.exports.csv.delimiter',
...
'signed','throttle','verified','admin','locale',
'country.restriction','csp',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','api.cart.count','api.favorites.check','api.products.search',
'api.notifications.index','api.notifications.mark-read','home','shop',
'product.show','category.show','pubg-uc','set-locale','search',
'products.filter','register','login',
...
'logout','dashboard','profile.edit','profile.update','profile.destroy',
'cart.index','cart.add','cart.update','cart.remove','cart.clear',
'checkout.index','checkout.process','checkout.success','checkout.cancel','orders.index',
'orders.show','orders.invoice','orders.cancel','favorites.index','favorites.toggle',
'favorites.remove','reviews.store','reviews.update','reviews.destroy','admin.dashboard',
'admin.categories.index','admin.categories.create','admin.categories.store','admin.categories.show','admin.categories.edit',
'admin.categories.update','admin.categories.destroy','admin.products.index','admin.products.create','admin.products.store',
'admin.products.show','admin.products.edit','admin.products.update','admin.products.destroy','admin.products.bulk-update',
'admin.products.apply-margin','admin.orders.index','admin.orders.show','admin.orders.update','admin.users.index',
'admin.users.create','admin.users.store','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.destroy','admin.pricing-rules.index','admin.pricing-rules.create','admin.pricing-rules.store','admin.pricing-rules.show',
'admin.pricing-rules.edit','admin.pricing-rules.update','admin.pricing-rules.destroy','admin.settings.index','admin.settings.update',
'admin.reports.index','admin.reports.sales','admin.reports.products','admin.reports.customers','admin.api-sync.index',
'admin.api-sync.categories','admin.api-sync.products','admin.api-sync.balance','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard.dashboard','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','cart','components.application-logo','components.auth-session-status',
...
'components.text-input','dashboard','emails.template','favorite.index','home',
'layouts.app','layouts.guest','layouts.navigation','pagination.custom','product',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','shop',
...
'validation.uuid','validation.custom.attribute-name.rule-name','app.nav.home','app.nav.shop','app.nav.categories',
'app.nav.cart','app.nav.orders','app.nav.profile','app.nav.admin','app.nav.login',
'app.nav.register','app.nav.logout','app.home.hero_title_1','app.home.hero_subtitle_1','app.home.hero_title_2',
'app.home.hero_subtitle_2','app.home.hero_title_3','app.home.hero_subtitle_3','app.home.best_sellers','app.home.trending',
'app.home.hot_deals','app.home.explore_collection','app.home.view_deals','app.home.get_started_now','app.home.create_account',
'app.home.view_all_products','app.home.instant_delivery','app.home.trusted_service','app.home.secure_payment','app.home.best_prices',
'app.home.stats.happy_customers','app.home.stats.digital_products','app.home.stats.instant_delivery_247','app.home.stats.countries_served','app.home.shop_by_category',
'app.home.browse_categories_subtitle','app.home.browse_collection','app.home.products','app.home.best_selling_products','app.home.no_products_available',
'app.home.why_choose_us','app.home.why_choose_subtitle','app.home.instant_delivery_desc','app.home.secure_payment_desc','app.home.24_7_support',
'app.home.24_7_support_desc','app.home.best_prices_desc','app.home.global_coverage','app.home.global_coverage_desc','app.home.money_back',
'app.home.money_back_desc','app.home.ready_to_level_up','app.home.level_up_description','app.shop.title','app.shop.search_placeholder',
'app.shop.filter_by_category','app.shop.sort_by','app.shop.newest','app.shop.price_low_high','app.shop.price_high_low',
'app.shop.most_popular','app.shop.best_rated','app.shop.view_details','app.shop.add_to_cart','app.shop.out_of_stock',
'app.shop.in_stock','app.shop.no_products_found','app.categories.all','app.categories.game_cards','app.categories.gift_cards',
'app.categories.subscriptions','app.categories.pubg_uc_topup','app.categories.instant_uc_delivery','app.cart.title','app.cart.empty',
'app.cart.continue_shopping','app.cart.remove','app.cart.quantity','app.cart.subtotal','app.cart.total',
'app.cart.checkout','app.cart.update','app.checkout.title','app.checkout.billing_information','app.checkout.payment_method',
'app.checkout.order_summary','app.checkout.place_order','app.checkout.processing','app.checkout.success','app.checkout.failed',
'app.order.title','app.order.order_number','app.order.date','app.order.status','app.order.total',
'app.order.view','app.order.download_invoice','app.order.pending','app.order.processing','app.order.completed',
'app.order.failed','app.order.cancelled','app.profile.title','app.profile.personal_information','app.profile.change_password',
'app.profile.current_password','app.profile.new_password','app.profile.confirm_password','app.profile.update','app.profile.save_changes',
'app.auth.login','app.auth.register','app.auth.email','app.auth.password','app.auth.remember_me',
'app.auth.forgot_password','app.auth.dont_have_account','app.auth.already_have_account','app.auth.name','app.auth.phone',
'app.auth.agree_terms','app.auth.login_to_account','app.auth.create_account','app.messages.success','app.messages.error',
'app.messages.cart_updated','app.messages.item_added','app.messages.item_removed','app.messages.order_placed','app.messages.profile_updated',
'app.messages.password_changed','app.messages.login_required',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE',
'APP_URL','SESSION_SECURE_COOKIE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'LIKECARD_API_URL','LIKECARD_DEVICE_ID','LIKECARD_EMAIL','LIKECARD_SECURITY_CODE','LIKECARD_PHONE',
'LIKECARD_KEY','LIKECARD_SECRET_KEY','LIKECARD_SECRET_IV','MAIL_MAILER','BREVO_HOST',
'BREVO_PORT','BREVO_USERNAME','BREVO_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS',
'MAIL_FROM_NAME','BREVO_API_KEY','BREVO_LIST_ID',);
